...
class TestProfile(TestCase):
    def setUp(self):
        self.user = User(id=1, username='admin', password='admin')
        self.user.save()
...
class hoodTest(TestCase):
    def setup(self):
        self.user = User.objects.create(id=a, username='admin')
        self.hood = Hood.objects.create(id=1, name='Huye', location='butare',image='default.jpg', police=123, health=119 )
